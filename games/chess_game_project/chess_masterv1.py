...
DIFF_WIDTH = 90
DIFF_HEIGHT = 50
BTN_EASY_RECT = pygame.Rect(CENTER_X - 5, DIFF_Y, DIFF_WIDTH, DIFF_HEIGHT)
BTN_MED_RECT = pygame.Rect(CENTER_X + 95, DIFF_Y, DIFF_WIDTH, DIFF_HEIGHT)
BTN_HARD_RECT = pygame.Rect(CENTER_X + 195, DIFF_Y, DIFF_WIDTH, DIFF_HEIGHT)
BTN_CLOCK_RECT = pygame.Rect(CENTER_X + 295, DIFF_Y, 120, DIFF_HEIGHT)
BTN_THEME_RECT = pygame.Rect(CENTER_X - 5, DIFF_Y + 70, BTN_WIDTH + 10, 60)
...
class AI:
    ...
    def get_best_move(self, board, game_ref, ai_color):
        ...
        for start, end in all_moves:
            temp_board = self.fast_copy_board(board)
